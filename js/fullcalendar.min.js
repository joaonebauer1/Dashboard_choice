    ...
    function $b(a, b) {
        ...
        function Q(c) {
            if (c) { if (!m.isFunction(c)) { var z = c + "";
                ...
                L = m.grep(L, c, true); for (H = 0; H < U.length; H++)
            ...
            s.draggable({
                ...
                start: function($, w) {
                    ...
                    Z.start(function(I, R, V, ea) { B(); if (I) { J = false;
                            ...
                            J = J || M && !k } else { F();
                            J = true }
                        s.draggable("option", "revert", J) }, $, "drag")
                },
                stop: function($, w) {
                    Z.stop();
                    B();
                ...
                start: function(I, R) { fa("eventDragStart", s, o, I, R);
                    ...
                    ia.start(function(V, ea, aa, va) { s.draggable("option", "revert", !V);
                        B(); if (V) { k = va * ja; if (u("allDaySlot") && !V.row) { if (!M) { M = true;
                                ...
                                E(ba(N(o.start), k), ba(Ua(o), k)) } else r() } }, I, "drag") },
