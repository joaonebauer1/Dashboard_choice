...
(function() {
    ...
    function la(a) { return typeof a === "string" }

    function X(a) { return typeof a === "object" }

    function Ha(a) { return Object.prototype.toString.call(a) === "[object Array]" }

    function Aa(a) { return typeof a === "number" }

    function ma(a) { return J.log(a) / J.LN10 }

    function ba(a) { return J.pow(10, a) }
    ...
    function Da(a) { for (var b = a.length, c = a[0]; b--;) a[b] > c && (c = a[b]); return c }
    ...
    function ua(a, b) { Oa = o(a, b.animation) }

    function Gb() {
        var a = M.global.useUTC,
            b = a ? "getUTC" : "get",
            c = a ? "setUTC" : "set";
        Ya = a ? Date.UTC : function(a, b, c, g, h, i) { return (new Date(a, b, o(c, 1), o(g, 0), o(h, 0), o(i, 0))).getTime() };
        jb = b + "Minutes";
        kb = b + "Hours";
        mb = b + "Day";
        La = b + "Date";
    ...
    cb = function(a, b, c) {
        ...
        var a = o(a, "%Y-%m-%d %H:%M:%S"),
            ...
            k = M.lang,
            l = k.weekdays,
            b = { a: l[g].substr(0, 3), A: l[g], d: sa(h), e: h, b: k.shortMonths[i], B: k.months[i], m: sa(i + 1), y: j.toString().substr(2, 2), Y: j, H: sa(f), I: sa(f % 12 || 12), l: f % 12 || 12, M: sa(d[jb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: sa(d.getSeconds()), L: sa(s(b % 1E3), 3) };
    ...
    var qa = function(a) {
        ...
        return {
            ...
            brighten: function(a) { if (Aa(a) && a !== 0) { var c; for (c = 0; c < 3; c++) b[c] += w(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255) } return this },
    ...
    va.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (la(a)) c = a, h === "circle" ? c = { x: "cx", y: "cy" }[c] || c : c === "strokeWidth" && (c = "stroke-width"), u = z(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (u = parseFloat(u));
            else
                for (c in a)
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (c || d) H(b, {
                    marginLeft: c,
                    marginTop: d
                }), j && n(j, function(a) { H(a, { marginLeft: c + 1, marginTop: d + 1 }) });
    ...
    ra.prototype = {
        ...
        button: function(a, b, c, d, e, f, g) {
            var h = this.label(a, b, c),
                i = 0,
                j, k, l, m, p, a = { x1: 0, y1: 0, x2: 0, y2: 1 },
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            var m = this,
                ...
                yb, g = p.attrSetters;
            I(p, "add", l);
            g.width = function(a) { Ga = a; return !1 };
            g.height = function(a) { v = a; return !1 };
            g.padding = function(a) { t(a) && a !== aa && (aa = a, j()); return !1 };
            g.align = function(a) { D = { left: 0, center: 0.5, right: 1 }[a]; return !1 };
            g.text = function(a, b) {
                u.attr(b, a);
                var c;
                c = u.element.style;
    ...
    if (!Z && !U) {
        ja = {
            ...
            clip: function(a) {
                var b = this,
                    c, d = b.element,
                    e = d.parentNode;
                a ? (c = a.members, c.push(b), b.destroyClip = function() { Ba(c, b) }, e && e.className === "highcharts-tracker" && !Qa && H(d, { visibility: "hidden" }), a = a.getCSS(b)) : (b.destroyClip &&
        ...
        ja = function() { this.init.apply(this, arguments) };
    ...
    nb.prototype = {
        render: function() {
            ...
            b.isLog && (j = ma(j),
                i = ma(i), l = ma(l));
            if (h) { if (u = b.getPlotLinePath(l, h), d = { stroke: q, "stroke-width": h }, m) d.dashstyle = m } else if (k) { if (j = y(j, b.min - d), i = O(i, b.max + d), u = b.getPlotBandPath(j, i, e), d = { fill: q }, e.borderWidth) d.stroke = e.borderColor, d["stroke-width"] = e.borderWidth } else return;
            if (t(D)) d.zIndex = D;
            if (p) u ? p.animate({ d: u }, null, p.onGetPath) : (p.hide(), p.onGetPath = function() { p.show() });
    ...
    ob.prototype = {
        ...
        setOptions: function(a) { this.options = A(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], A(M[this.isXAxis ? "xAxis" : "yAxis"], a)) },
        ...
        getSeriesExtremes: function() {
            ...
            n(a.series, function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) { if (h = g.xData, h.length) a.dataMin = O(o(a.dataMin, h[0]), Ma(h)), a.dataMax = y(o(a.dataMax, h[0]), Da(h)) } else {
        ...
        getLogTickPositions: function(a, b, c, d) {
            ...
            if (a >= 0.5) a = s(a), g = this.getLinearTickPositions(a, b, c);
                ...
                for (var f = T(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) { i = e.length; for (h = 0; h < i && !l; h++) j = ma(ba(f) * e[h]), j > b && g.push(k), k > c && (l = !0), k = j } else if (b = ba(b), c = ba(c), a = e[d ? "minorTickInterval" : "tickInterval"],
        ...
        getMinorTickPositions: function() {
            var a = this.tickPositions,
                ...
                c = [],
                d, e;
            if (this.isLog) { e = a.length; for (d = 1; d < e; d++) c = c.concat(this.getLogTickPositions(b, a[d - 1], a[d], !0)) } else
        ...
        getOffset: function() {
            ...
            if (b || a.isLinked) n(e, function(b) { f[b] ? f[b].addLabel() : f[b] = new Pa(a, b) }), n(e, function(a) {
                if (h === 0 || h === 2 || {
                        1: "left",
                        3: "right"
        ...
        destroy: function() {
            ...
            n([a.ticks, a.minorTicks, a.alternateBands, a.plotLinesAndBands], function(a) { Ea(a) });
            ...
            if (p) {
                ...
                for (e = p.length; e--;)
                    if (i = a.series[e ? "yAxis" : "xAxis"], p[e] && i)
                        if (i = i.getPlotLinePath(e ? o(a.stackY, a.y) : a.x, 1), this.crosshairs[e]) this.crosshairs[e].attr({ d: i, visibility: "visible" });
                        else {
    ...
    rb.prototype = {
        ...
        handleOverflow: function(a) {
            ...
            if (a > f) {
                ...
                this.fullHeight = a;
                h.attr({ height: c });
                if (!l) this.nav = l = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, k, k).on("click", function() { b.scroll(-1, j) }).add(l), this.pager = d.text("", 15, 10).css(i.style).add(l),
                    this.down = d.symbol("triangle-down", 0, 0, k, k).on("click", function() { b.scroll(1, j) }).add(l);
                b.scroll(0);
                a = f
        ...
        scroll: function(a, b) {
            var c = this.pageCount,
                ...
                i = this.padding;
            d > c && (d = c);
            if (d > 0) b !== x && ua(b, this.chart), this.nav.attr({ translateX: i, translateY: e + 7, visibility: "visible" }), this.up.attr({
                fill: d ===
                    1 ? f : g
    ...
    sb.prototype = {
        ...
        getMargins: function() {
            ...
            if (f.display && !m.floating)
                if (q === "right") { if (!t(i)) this.marginRight = y(this.marginRight, f.legendWidth - u + p + c) } else if (q === "left") { if (!t(h)) this.plotLeft = y(this.plotLeft, f.legendWidth + u + p + a) } else if (s === "top") { if (!t(g)) this.plotTop = y(this.plotTop, f.legendHeight + r + p + b) } else if (s === "bottom" && !t(j)) this.marginBottom = y(this.marginBottom, f.legendHeight - r + p + d);
        ...
        initReflow: function() {
            function a(a) {
                var g = c.width || db(d, "width"),
                    ...
                    a = a ? a.target : K;
                if (g && h && (a === K || a === C)) {
                    if (g !== b.containerWidth || h !== b.containerHeight) clearTimeout(e), b.reflowTimeout = e = setTimeout(function() { b.container && b.resize(g, h, !1) }, 100);
                    b.containerWidth = g;
                    b.containerHeight =
                        h
                }
            ...
            var b = this,
                ...
                e;
            I(K, "resize", a);
            I(b, "destroy", function() { S(K, "resize", a) })
        },
    ...
    Ta.prototype = {
        ...
        setState: function(a) {
            ...
            if (!(a === this.state || this.selected && a !== "select" || e[a] && e[a].enabled === !1 || a && (i || g && !h.enabled))) {
                if (this.graphic) e = f && this.graphic.symbolName && l[a].r, this.graphic.attr(A(l[a], e ? { x: b - e, y: c - e, width: 2 * e, height: 2 * e } : {}));
    ...
    N.prototype = {
        ...
        tooltipHeaderFormatter: function(a) {
            ...
            if (e && !c)
                for (f in B)
                    if (B[f] >= d.closestPointRange) { c = b.dateTimeLabelFormats[f]; break }
        ...
        animate: function(a) {
            ...
            if (a) a = c[h], e = c[h + "m"], a || (c[h] = a = d.clipRect(r(f, { width: 0 })), c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group.clip(a), b.markerGroup.clip(e), b.sharedClipKey = h;
                ...
                b.animate = null;
                b.animationTimeout = setTimeout(function() { b.afterAnimate() },
                    e.duration)
            }
        },
        ...
        destroy: function() {
            ...
            E(a, "destroy");
            S(a);
            n(["xAxis", "yAxis"], function(b) { if (i = a[b]) Ba(i.series, a), i.isDirty = !0 });
    ...
    var za = G.prototype,
        ha = ca(ha, { type: "areaspline", closedStacks: !0, getSegmentPath: za.getSegmentPath, closeSegment: za.closeSegment, drawGraph: za.drawGraph });
    $.areaspline = ha;
    W.column = A(ga, {
        borderColor: "#FFFFFF",
        borderWidth: 1,
    ...
    $.scatter = za;
    W.pie = A(ga, { borderColor: "#FFFFFF", borderWidth: 1, center: ["50%", "50%"], colorByPoint: !0, dataLabels: { distance: 30, enabled: !0, formatter: function() { return this.point.name } }, legendType: "point", marker: null, size: "75%", showInLegend: !1, slicedOffset: 10, states: { hover: { brightness: 0.1, shadow: !1 } } });
    ya = {
        type: "pie",
        isCartesian: !1,
        pointClass: ca(Ta, {
        ...
        translate: function() {
            ...
            this.getX = function(a, b) { j = J.asin((a - f[1]) / (f[2] / 2 + m)); return f[0] + (b ? -1 : 1) * V(j) * (f[2] / 2 + m) };
            ...
            if (d.enabled || this._hasPointLabels) {
                ...
                for (a = r[0][0] && r[0][0].dataLabel && (r[0][0].dataLabel.getBBox().height ||
                    ...
                    for (v = 0; v < C; v++) {
                        ...
                        s = h[1];
                        if (j > 0) { if (q = A.pop(), B = q.i, q = q.y, s > q && x[B + 1] !== null || s < q && x[B - 1] !== null) q = s } else q = s;
